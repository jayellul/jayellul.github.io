...
class Aboutpage extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div
          className="aboutpage-text-wrapper"
        ...
        <div style={{ padding: "0 5vw", overflow: "hidden" }}>
          ...
          <div className="project-wrapper">
            <div
              className="motive-pic-3"
              style={{
                backgroundImage: `url(${motiveposts})`,
                backgroundPosition: motive ? "center bottom" : "center 100vh",
                opacity: motive ? 1 : 0,
              }}
            />
            <div
              className="motive-pic-2"
              style={{
                backgroundImage: `url(${motiveprofile})`,
                backgroundPosition: motive ? "center bottom" : "center 100vh",
                opacity: motive ? 1 : 0,
              }}
            />
            <div
              className="motive-pic-1"
              style={{
                backgroundImage: `url(${motivemap})`,
                backgroundPosition: motive ? "center bottom" : "center 100vh",
                opacity: motive ? 1 : 0,
              }}
            />
            ...
            >
              <div
                ...
                style={{
                  opacity: motive ? 1 : 0,
                  filter: motive ? "blur(0px)" : "blur(5px)",
                }}
              >
                <p className="project-title">Motive</p>
                <p className="project-text">
                  Motive is a map-based social network I founded where users
                  post events onto a map for their friends and followers to see.
                  Other users can then comment on or announce that they are
                  going to the posts.
                </p>
                ...
                >
                  <div
                    onClick={() =>
                      window.open(
                        "https://apps.apple.com/us/app/motive/id1448925991",
                        "_blank"
                      )
                    }
                  ...
                  <div
                    onClick={() =>
                      window.open(
                        "https://github.com/jayellul/Motive",
                        "_blank"
                      )
                    }
          ...
          <div className="project-wrapper">
            <div
              className="tidy-pic-2"
              style={{
                backgroundImage: `url(${tidyhome})`,
                backgroundPosition: tidy ? "center bottom" : "center 100vh",
                opacity: tidy ? 1 : 0,
              }}
            />
            <div
              className="tidy-pic-1"
              style={{
                backgroundImage: `url(${tidyfeed})`,
                backgroundPosition: tidy ? "center bottom" : "center 100vh",
                opacity: tidy ? 1 : 0,
              }}
            />
            ...
            >
              <div
                ...
                style={{
                  opacity: tidy ? 1 : 0,
                  filter: tidy ? "blur(0px)" : "blur(5px)",
                }}
              >
                <p className="project-title">Tidy</p>
                <p className="project-text">
                  Tidy is an app I created to keep track of chores around the
                  house. Send your housemates friendly reminders in the form of
                  push notifications to let them know they need to do some
                  chores.
                </p>
                {/* Tidy access buttons */}
                <div
                ...
                >
                  <div
                    onClick={() =>
                      window.open(
                        "https://testflight.apple.com/join/4RrExVH9",
                        "_blank"
                      )
                    }
                  ...
                  <div
                    onClick={() =>
                      window.open("https://github.com/jayellul/Tidy", "_blank")
                    }
                    className="button-github"
                  >
                    <img src={github} style={{ height: "1.2em" }} />
          ...
          <div className="project-wrapper">
            {/* Pictures of design */}
            <div
              className="website-pic-2"
              style={{
                backgroundImage: `url(${securcormission})`,
                opacity: securcor ? 1 : 0,
              }}
            />
            <div
              className="rellax"
            ...
            >
              <div
                ...
                style={{
                  opacity: securcor ? 1 : 0,
                  filter: securcor ? "blur(0px)" : "blur(5px)",
                }}
              >
                ...
                <p className="project-text">
                  External website for Securcor, a financial group in the
                  securitization industry dedicated to reducing financing costs.
                </p>
                ...
                >
                  <div
                    onClick={() => window.open("http://securcor.com", "_blank")}
                    className="button-primary"
                  >
                    <p>Visit Site</p>
                  </div>
                  <div
                    onClick={() =>
                      window.open("https://jayellul.github.io/coop-reports/")
                    }

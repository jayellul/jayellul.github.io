...
class Resumepage extends Component {
  ...
  handleScroll(e) {
    ...
    if (!this.state.link1 && this.link1 && this.link1.getBoundingClientRect().top - window.innerHeight < -100) {
      this.setState({ link1: true });
    }
    if (!this.state.link2 && this.link2 && this.link2.getBoundingClientRect().top - window.innerHeight < -100) {
      this.setState({ link2: true });
    }
    if (!this.state.link3 && this.link3 && this.link3.getBoundingClientRect().top - window.innerHeight < -100) {
      this.setState({ link3: true });
    }
    if (!this.state.link4 && this.link4 && this.link4.getBoundingClientRect().top - window.innerHeight < -100) {
